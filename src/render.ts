                  ...
                  <div class="mt-6 rounded-xl border border-[#1877f2]/30 bg-[#1877f2]/10 px-4 py-3">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        ...
                        <p class="mt-0.5 text-xs" style="color: color-mix(in srgb, var(--news-card-text) 68%, transparent);">Register a free member account to like articles and help Tanne Hub know what content to write next.</p>
                      </div>
                      ${renderHelpfulButton(post.id)}
                    </div>
                  </div>
