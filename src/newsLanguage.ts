...
const siteCopy = {
  en: {
    ...
    close: "Close",
    latestPromoCode: "Latest code",
    promoCodeCount: "{count} active codes",
    searchPromoCodes: "Search promo codes",
    copyPromoCode: "Copy",
    copiedPromoCode: "Copied",
    noPromoSearchResults: "No matching promo codes.",
    promoAllPlayersTitle: "All players",
    promoNewPlayersTitle: "New players only",
    promoNewPlayersActiveOnly: "Active only for new players!",
    promoNewPlayersOnePerAccount: "Only one new-player code can be used per account.",
  ...
  vi: {
    ...
    close: "Đóng",
    latestPromoCode: "Mã mới nhất",
    promoCodeCount: "{count} mã đang có",
    searchPromoCodes: "Tìm mã promo",
    copyPromoCode: "Copy",
    copiedPromoCode: "Đã copy",
    noPromoSearchResults: "Không tìm thấy mã phù hợp.",
    promoAllPlayersTitle: "Tất cả người chơi",
    promoNewPlayersTitle: "Chỉ dành cho người chơi mới",
    promoNewPlayersActiveOnly: "Chỉ hoạt động cho tài khoản mới!",
    promoNewPlayersOnePerAccount: "Mỗi tài khoản chỉ dùng được một mã newbie.",
