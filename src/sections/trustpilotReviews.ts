...
function renderTrustpilotStars(): string {
  return `
    <div class="flex items-center gap-1" aria-label="Trustpilot star rating">
      ${Array.from({ length: 5 })
        .map(
          () => `
    ...
    <section class="theme-smooth rounded-[14px] border border-[#00b67a]/35 bg-[var(--panel-bg)] p-4 text-[var(--panel-text)] shadow-[0_4px_14px_rgba(31,36,51,0.06)] md:p-5" aria-labelledby="trustpilot-heading">
      <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div class="min-w-0">
          ...
          <h2 id="trustpilot-heading" class="mt-1 text-[21px] font-extrabold leading-tight">Public customer feedback</h2>
        ...
        <div class="grid gap-3 sm:grid-cols-[1fr_auto] sm:items-center lg:min-w-[460px]">
          <div class="rounded-xl border border-[#00b67a]/30 bg-[#00b67a]/10 p-3">
            <div class="flex flex-wrap items-center justify-between gap-2">
              <p class="text-[12px] font-extrabold text-[#00b67a]">Trustpilot profile</p>
            ...
            <div class="mt-2 flex flex-wrap items-end gap-3">
              ...
              <p class="pb-1 text-sm font-extrabold text-[var(--panel-text)]">Trustpilot reviews</p>
            </div>
            <p class="mt-2 text-[12px] leading-snug text-[var(--panel-muted)]">Live public reviews are available on Trustpilot. The score should be checked on the official profile.</p>
          </div>
          <a
